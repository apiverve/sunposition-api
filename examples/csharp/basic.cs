    ...
    class SunPositionExample
    {
        ...
        static async Task<JsonDocument> CallSunPositionAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;lat&quot;] &#x3D; 37.7749, [&quot;lon&quot;] &#x3D; -122.4194, [&quot;time&quot;] &#x3D; &quot;14:30&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Sun Position API...\n");

            var result = await CallSunPositionAPI();
