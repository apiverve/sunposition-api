# Sun Position API - Examples

This folder contains example code for using the Sun Position API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/sunposition',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/sunposition");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/sunposition](https://docs.apiverve.com/ref/sunposition)
