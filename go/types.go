...
// Request contains the parameters for the Sun Position API.
//
// Parameters:
...
// ResponseData contains the data returned by the Sun Position API.
...
// SunData represents the sun object.
type SunData struct {
