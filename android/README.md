...
```gradle
dependencies {
    implementation 'com.github.apiverve:sunposition-api:1.1.12'
}
```
...
```java
import com.apiverve.sunposition.SunPositionAPIClient;
import com.apiverve.sunposition.APIResponse;
import com.apiverve.sunposition.APIException;

// Initialize the client
SunPositionAPIClient client = new SunPositionAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/sunposition](https://docs.apiverve.com/ref/sunposition)
...
- **Documentation:** [https://docs.apiverve.com/ref/sunposition](https://docs.apiverve.com/ref/sunposition)
- **Issues:** [GitHub Issues](https://github.com/apiverve/sunposition-api/issues)
