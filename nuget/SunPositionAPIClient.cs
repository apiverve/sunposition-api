...
namespace APIVerve.API.SunPosition
{
    ...
    /// <summary>
    /// Client for the SunPosition API
    /// </summary>
    public class SunPositionAPIClient
#if !NET20 && !NET35 && !NET40
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/sunposition";
        ...
        private static readonly Dictionary<string, ValidationRule> _validationRules = new Dictionary<string, ValidationRule>
        {
            ...
            { "time", new ValidationRule { Type = "string", Required = false, Format = "time" } }
        };
        ...
        public SunPositionAPIClient(string apiKey)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public SunPositionAPIClient(string apiKey, bool isSecure, bool isDebug)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public SunPositionAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, SunPositionQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(SunPositionQueryOptions options)
        {
        ...
        public ResponseObj Execute(SunPositionQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(SunPositionQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(SunPositionQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(SunPositionQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(SunPositionQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(SunPositionQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(SunPositionQueryOptions options)
        {
